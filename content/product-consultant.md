...
<div class="lp-hero">
  <div style="max-width:48rem;margin:0 auto">
    ...
    <div>
      <a href="https://zeeg.me/amirhp/30min" target="_blank" rel="noopener" class="lp-btn lp-btn-primary">رزرو مشاوره رایگان ←</a>
    </div>
    <div style="margin-top:.75rem">
      <a href="#pricing" class="lp-btn lp-btn-ghost">مشاهده بسته‌های مشاوره ↓</a>
    </div>
    <div class="lp-stats">
