...
title: "کتاب Lean UX"
date: 2026-09-15
description: "معرفی تخصصی، بررسی سرفصل‌ها و دانلود نسخه کامل کتاب Lean UX در حوزه طراحی تجربه کاربری و روانشناسی برای مدیران محصول و طراحان."
tags: ["کتابخانه", "طراحی تجربه کاربری و روانشناسی", "مدیریت محصول"]
categories: ["کتاب‌ها"]
---

کتاب **Lean UX** یکی از مراجع معتبر و پرکاربرد در حوزه **طراحی تجربه کاربری و روانشناسی** است. این اثر به بررسی راهکارها، متدولوژی‌ها و تجربیات عملی متخصصان این حوزه می‌پردازد و راهنمای مفیدی برای تیم‌های محصول، استارتاپ‌ها و مدیران کسب‌وکار به شمار می‌رود.
...
{{< book-download url="https://dl.theminiceo.ir/Lean-UX.pdf" title="دانلود کتاب Lean UX (نسخه کامل)" size="3.3 مگابایت" format="PDF" >}}
