---
title: "کتاب A Manager s Guide to Coaching"
date: 2026-09-15
description: "معرفی تخصصی، بررسی سرفصل‌ها و دانلود نسخه کامل کتاب A Manager s Guide to Coaching در حوزه طراحی تجربه کاربری و روانشناسی برای مدیران محصول و طراحان."
tags: ["کتابخانه", "طراحی تجربه کاربری و روانشناسی", "مدیریت محصول"]
categories: ["کتاب‌ها"]
---

کتاب **A Manager s Guide to Coaching** یکی از مراجع معتبر و پرکاربرد در حوزه **طراحی تجربه کاربری و روانشناسی** است. این اثر به بررسی راهکارها، متدولوژی‌ها و تجربیات عملی متخصصان این حوزه می‌پردازد و راهنمای مفیدی برای تیم‌های محصول، استارتاپ‌ها و مدیران کسب‌وکار به شمار می‌رود.
...
{{< book-download url="https://dl.theminiceo.ir/A_Manager_s_Guide_to_Coaching.pdf" title="دانلود کتاب A Manager s Guide to Coaching (نسخه کامل)" size="1.9 مگابایت" format="PDF" >}}
