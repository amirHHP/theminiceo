...
- اهداف استراتژیک خود را مشخص کنید: قبل از شروع به انجام کاری، بهتر است هدف خود از انجام آن کار را مشخص کنیم. این می‌تواند در قالب یک کمپین در یک تیم بازاریابی باشد و یا راه‌اندازی یک وبسایت کسب و کار خانگی. مهم نیست در چه نوع کسب و کاری است و یا حجم انجام کار چقدر است؛ نکته قابل اهمیت هدفمند بودن انجام آن کار است. پیشتر در مورد استراتژی محصول در [اینجا](/docs/archive/good-product-strategy/) نوشته‌ایم.
