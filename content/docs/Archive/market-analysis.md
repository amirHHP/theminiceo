...
شاید لازم باشد بعد از ارزیابی بازار [فرصت‌های محصول‌تان](/assessing-product-opportunities/) را هم بررسی کنید.
...
تحلیل رقابت را می توان در سطوح مختلف سازمان انجام داد. [تحلیل محصول رقبا](/docs/archive/product-manager-guide-to-competitive-analysis/) هم بخشی از این قضیه است. اولین تحلیل این است که رقبای خود را شناسایی کنید. توجه داشته باشید که رقبا می توانند انواع مختلفی داشته باشند:
...
- فناوری (فناوری پیشرفته لازم برای طراحی یک وبسایت با فرآوری اورانیوم یکسان نیستند به عنوان مدیر محصول باید [تسلط فنی لازم](/docs/archive/being-technical-enough-as-a-product-manager/) داشته باشید)
