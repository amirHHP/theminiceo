...
در این روش، یک نمای کلی از بک‌لاگ‌های موجود برای هر محصول بدست می‌آوریم و علاوه بر آن، چشم‌اندازی از [یوزر استوری مپینگ](/docs/archive/userstory-mapping/) نیز در اختیار مدیر محصول قرار می‌گیرد. که این موضوع کارهایی که در هر مرحله بایستی به انجام برسند را به خوبی مشخص می‌کند.
