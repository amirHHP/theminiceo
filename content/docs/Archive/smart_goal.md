...
در مطالب قبل در مورد [شاخص کلیدی عملکرد  (KPI)](/product-articles/key_performance_indicator/) و همچنین چند مثال از شاخص‌های کلیدی عملکرد در کسب و کارهای مختلف صحبت کردیم.  و همچنین اشاره شد که یکی از روش‌های متداول تعریف شاخص کلیدی عملکرد (KPI)  مدل S.M.A.R.T است. در این مقاله به بررسی این مدل می‌پردازیم.
