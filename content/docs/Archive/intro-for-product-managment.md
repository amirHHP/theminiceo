...
**[مدیران محصول خوب](/product-basics/good-bad-product-manager/) مسئولیت کامل را برعهده می‌گیرند و موفقت خود را در موفقیت محصول می‌سنجند.**
...
شخص CPO معمولا به‌صورت مستقیم به مدیرعامل یا همانCEO  گزارش می‌دهد و مسئول تمامی فعالیت‌های محصولی داخل سازمان می‌باشد. آن‌ها **معمولا روی چیدن [استراتژی کلی محصول](/product-strategy/good-product-strategy/) تمرکز دارند** که با‌توجه به چشم‌انداز و اهداف سازمان که توسط مدیرعامل و اعضای هیات مدیره طراحی می‌شود. گاهی اوقات CPO نقش CMO را نیز انجام می‌دهد. در این حالت آن‌ها وظیفه مدیریت بازاریابی و توسعه محصول را برعهده دارند.
...
در کنار این وظایف، یک مدیر محصول نرم افزار باید با [ابزارهای مختلفی](/product-skills/product-management-tools/) برای شناسایی نیاز محصول و رفتار کاربران کار کند.
...
کتاب [راهنمای بقای مدیر محصول](/downloads/survival-guide-for-product-managers/) یک منبع خوب برای آموزش این موضوع است.
